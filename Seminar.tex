...
\begin{itemize}
\item \textbf{Location privacy} is the most straightforward of attack vectors. Whenever a user publishes their location they associate their identity with that location and possibly reveal sensitive information.
\end{itemize}
