...
When using k-anonymity in LBS context Gedik et al.\cite{Gedik2008} noted that the method achieved good success rates and level of anonymity while not incurring significant overheads to the performance. Though, as with all query enlargement techniques
